            ...
            <section class="p-quiz-box js-quiz" data-quiz="<?= $i ?>">
                ...
                <div class="p-quiz-box__answer">
                    ...
                    <ul class="p-quiz-box__answer__list">
                        <?php foreach($questions[$i]["choices"] as $index => $choice){ ?>
                            <li class="p-quiz-box__answer__item">
                                <button class="p-quiz-box__answer__button js-answer" data-answer="<?= $index; ?>" data-correct="<?= $choice["valid"]; ?>">
                        ...
                        <p class="p-quiz-box__answer__correct__content">
                            ...
                            <span class="js-answerText">
                                ...
                                for($j = 0; $j < count($questions[$i]["choices"]); $j++) { 
                                    if($questions[$i]["choices"][$j]["valid"]==1){
                                        echo $questions[$i]["choices"][$j]["name"]; 
                                        }
                                    }
                                ?></span>
                        </p>
            ...
            <!-- <section class="p-quiz-box js-quiz" data-quiz="1"> -->
                <!-- <div class="p-quiz-box__question">
                    <h2 class="p-quiz-box__question__title">
                        ...
                        <span
                            class="p-quiz-box__question__title__text">既存業界のビジネスと、先進的なテクノロジーを結びつけて生まれた、新しいビジネスのことをなんと言うでしょう？</span>
                    </h2>
                    <figure class="p-quiz-box__question__image">
            ...
            <!-- <section class="p-quiz-box js-quiz" data-quiz="5"> -->
                <!-- <div class="p-quiz-box__question">
                    <h2 class="p-quiz-box__question__title">
                        ...
                        <span
                            class="p-quiz-box__question__title__text">先進テクノロジー活用企業と出遅れた企業の収益性の差はどれくらいあると言われているでしょうか？</span>
                    </h2>
                    <figure class="p-quiz-box__question__image">
